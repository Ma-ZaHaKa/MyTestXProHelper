...
namespace MyTestXProHelper
{
  public class Settings : Form
  {
    ...
    public Settings()
    {
      ...
      this.headSignatureTextBox.Text = Properties.Settings.Default.HeadSignature;
      this.tailSignatureTextBox.Text = Properties.Settings.Default.TailSignature;
      this.patchSignatureTextBox.Text = Properties.Settings.Default.PatchSignature;
      this.mtsReplaceTextBox.Text = Properties.Settings.Default.ReplaceWith;
      this.maskBox.Text = Properties.Settings.Default.SignatureMask;
      this.replaceMaskTextBox.Text = Properties.Settings.Default.ReplaceMask;
      this.mteOriginalByteTextBox.Text = Properties.Settings.Default.mteOriginalByte;
      this.mteReplaceTextBox.Text = Properties.Settings.Default.mteReplaceWith;
      this.mteOffsetTextBox.Text = Properties.Settings.Default.mteOffset;
    }
    ...
    {
      Properties.Settings.Default.HeadSignature = this.headSignatureTextBox.Text;
      Properties.Settings.Default.TailSignature = this.tailSignatureTextBox.Text;
      Properties.Settings.Default.PatchSignature = this.patchSignatureTextBox.Text;
      Properties.Settings.Default.ReplaceWith = this.mtsReplaceTextBox.Text;
      Properties.Settings.Default.SignatureMask = this.maskBox.Text;
      Properties.Settings.Default.ReplaceMask = this.replaceMaskTextBox.Text;
      Properties.Settings.Default.mteOriginalByte = this.mteOriginalByteTextBox.Text;
      Properties.Settings.Default.mteReplaceWith = this.mteReplaceTextBox.Text;
      Properties.Settings.Default.mteOffset = this.mteOffsetTextBox.Text;
      this.Close();
    }
