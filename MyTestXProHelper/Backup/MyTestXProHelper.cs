...
// Type: MyTestXProHelper.MyTestXProHelper
...
{
  public class MyTestXProHelper : Form
  {
    ...
    {
      string headSignature = MyTestXProHelper.Properties.Settings.Default.HeadSignature;
      string tailSignature = MyTestXProHelper.Properties.Settings.Default.TailSignature;
      string patchSignature = MyTestXProHelper.Properties.Settings.Default.PatchSignature;
      string signatureMask = MyTestXProHelper.Properties.Settings.Default.SignatureMask;
      string replaceWith = MyTestXProHelper.Properties.Settings.Default.ReplaceWith;
      string replaceMask = MyTestXProHelper.Properties.Settings.Default.ReplaceMask;
      ...
      else
      {
        ...
        else
        {
          ...
          if (text2.Length > 0)
          {
            ...
            File.Copy(text2, str);
            byte[] byteArray1 = MyTestXProHelper.MyTestXProHelper.StringToByteArray(patchSignature);
            byte[] byteArray2 = MyTestXProHelper.MyTestXProHelper.StringToByteArray(signatureMask);
            byte[] byteArray3 = MyTestXProHelper.MyTestXProHelper.StringToByteArray(replaceWith);
            byte[] byteArray4 = MyTestXProHelper.MyTestXProHelper.StringToByteArray(replaceMask);
            ...
            int subArrayMasked = MyTestXProHelper.MyTestXProHelper.FindSubArrayMasked(OriginalData, byteArray1, byteArray2);
            if (subArrayMasked == -1)
            {
              int num6 = (int) MessageBox.Show("Failed to find signature in .exe-file", "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
              return;
            }
            MyTestXProHelper.MyTestXProHelper.ReplaceArrayMasked(ref OriginalData, subArrayMasked, byteArray3, byteArray4);
          ...
          byte[] byteArray5 = MyTestXProHelper.MyTestXProHelper.StringToByteArray(headSignature);
          byte[] byteArray6 = MyTestXProHelper.MyTestXProHelper.StringToByteArray(tailSignature);
    ...
    {
      string mteOriginalByte = MyTestXProHelper.Properties.Settings.Default.mteOriginalByte;
      string mteReplaceWith = MyTestXProHelper.Properties.Settings.Default.mteReplaceWith;
      string mteOffset = MyTestXProHelper.Properties.Settings.Default.mteOffset;
      ...
      else
      {
        ...
        byte[] byteArray1 = MyTestXProHelper.MyTestXProHelper.StringToByteArray(mteOriginalByte);
        byte[] byteArray2 = MyTestXProHelper.MyTestXProHelper.StringToByteArray(mteReplaceWith);
        int selectedIndex = this.processListBox.SelectedIndex;
        int num2 = 0;
        int ProcessId = -1;
        foreach (KeyValuePair<int, string> process in this.ProcessList)
    ...
    public static byte[] StringToByteArray(string hex)
    {
      ...
      for (int index = 0; index < hex.Length >> 1; ++index)
        numArray[index] = (byte) ((MyTestXProHelper.MyTestXProHelper.GetHexVal(hex[index << 1]) << 4) + MyTestXProHelper.MyTestXProHelper.GetHexVal(hex[(index << 1) + 1]));
      return numArray;
    }
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (MyTestXProHelper.MyTestXProHelper));
